...
class PostgresAdapter extends BaseAdapter_1.BaseAdapter {
     ...
     */
    _buildRlsDefaultColumnValueStatements() {
        const rlsColumn = this.options.migrations.rlsMultiTenantColumnName || 'tenantId';
        const defaultValueForTenantColumn = `current_setting('app.current_tenant')`;
        const rlsStatements = [];
    ...
    async _deployCdsToReferenceDatabase() {
        ...
        const client = new pg_1.Client(getCredentialsForClient(credentials));
        const isRlsMultiTenant = (_a = this.options.migrations.rlsMultiTenant) !== null && _a !== void 0 ? _a : false;
        if (isRlsMultiTenant) {
